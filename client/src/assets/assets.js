// Import all asset files for user interface elements, icons, and images
...
import screen_share_icon from "./screen_share_icon.png";
import video_off_icon from "./video_off_icon.png";
...
// Exported object containing all commonly used asset references
const assets = {
  avatar_icon,
  gallery_icon,
  help_icon,
...
// Exported array of dummy image data used for testing gallery or chat media
export const imagesDummyData = [pic1, pic2, pic3, pic4, pic1, pic2];

// Exported array of sample user data to simulate active chat users
...
// Exported array of sample messages to simulate chat history for development
export const messagesDummyData = [
  ...
  },
  {
    ...
    senderId: "680f50e4f10f3cd28382ecf9",
    receiverId: "680f5116f10f3cd28382ed02",
    image: img1, // Image message sent in chat
    seen: true,
  ...
  },
  {
    ...
    senderId: "680f5116f10f3cd28382ed02",
    receiverId: "680f50e4f10f3cd28382ecf9",
    image: img2, // Another image message
    seen: true,
